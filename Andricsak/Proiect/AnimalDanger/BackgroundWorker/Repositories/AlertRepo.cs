...
namespace BackgroundWorker.Repositories
{
    public class AlertRepo
    {
        ...
        public async Task DeleteEnetityAsync(string partitionKey, string rowKey)
        {
            TableOperation retrieveOperation = TableOperation.Retrieve<Alert>(partitionKey, rowKey);
            ...
            Alert deleteEntity = (Alert)retrievedResult.Result;
            ...
            if (deleteEntity != null)
            {
                ...
                // Execute the operation.
                await alertsTable.ExecuteAsync(deleteOperation);
